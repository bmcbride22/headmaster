<template>
  <div class="flex flex-col">
    <Listbox as="div" v-if="semesters" v-model="selected" class="self-end">
      <div class="relative mt-1">
        ...
        >
          ...
          <span class="block truncate ml-8 pr-12 text-gray-500">Select Semester</span>
          ...
          >
            ...
            >
              <li :class="[active ? 'text-white bg-indigo-600' : 'text-gray-900', 'relative cursor-default select-none py-2 pl-8 pr-4']">
                <span :class="[selected ? 'font-semibold' : 'font-normal', 'block truncate']">{{ semester.title }}</span>
                <span
                  v-if="selected"
...
export default {
  ...
  components: { Line, Listbox, ListboxButton, ListboxOption, ListboxOptions, CheckIcon, ChevronDownIcon },
  props: {
    propData: {
      type: Object,
      default: () => {
  ...
  data() {
    return {
      selected: this.semesters ? this.semesters[this.current] : null,
  ...
  methods: {
    changeSemesterData() {
      console.log("propData[current] = ", this.propData[this.current]);
      console.log("propData = ", this.propData);
      console.log("selected = ", this.selected);
      console.log("propData[selected] = ", this.propData[this.selected]);
